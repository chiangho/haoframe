package hao.framework.core.spring;
...
public class SpringContext implements ApplicationContextAware, DisposableBean {
    ...
    private static Logger logger =LogManager.getLogger(SpringContext.class);//this.getClass(). ;//LoggerFactory.getLogger(SpringContext.class);
...
//		logger.debug("注入ApplicationContext到SpringContextUtil:{}", applicationContext);
        ...
        if (SpringContext.applicationContext != null) {
            logger.info("SpringContextUtil中的ApplicationContext被覆盖, 原有ApplicationContext为:" + SpringContext.applicationContext);
        }
